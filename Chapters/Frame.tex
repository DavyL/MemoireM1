...
\begin{theoreme}\label{th:orth1}
	...
	\end{equation*}.
\end{theoreme}
On peut illustrer ce théorème en disant que l'analyse par une famille orthogonale n'ajoute pas d'énergie au vecteur analysé.
...
\end{equation}
c'est à dire que les fonctions d'un espace $V_j$ sont des versions dilatées d'un facteur $2^{-j}$ des fonctions de l'espace $V_0$.
...
\begin{figure}[h]
	\includegraphics[width=\columnwidth]{Figs/mallatcont}
...
\end{figure}
\begin{figure}[h]
	\includegraphics[height=15cm, width=10cm ]{Figs/mallatdisc}
