...
\begin{proof}
	...
	\begin{lemme}\label{th:muFD}
		Soit $\Phi=(T,W)$ la paire de bases Fourier-Dirac, alors pour n'importe quels sous ensemble d'indices $\Gamma_T$ de $T$ et $\Gamma_W$ de $W$, on a,
		\begin{equation}
			\mu(\Gamma_T, \Gamma_W) < \frac{1}{2}.
		\end{equation}
	\end{lemme}
	...
	\begin{proof}
		...
		\end{equation}
	\end{proof}	
	On peut maintenant passer à la preuve du lemme \ref{th:mmuFD}
